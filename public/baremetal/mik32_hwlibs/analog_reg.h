...
#define TSENS_CFG_CLK_MUX_SYSTEM    0
#define TSENS_CFG_CLK_MUX_AHB       (1 << TSENS_CFG_CLK_MUX_S)
#define TSENS_CFG_CLK_MUX_OSC32M    (2 << TSENS_CFG_CLK_MUX_S)
#define TSENS_CFG_CLK_MUX_HSI32M    (3 << TSENS_CFG_CLK_MUX_S)
#define TSENS_CFG_CLK_MUX_OSC32K    (4 << TSENS_CFG_CLK_MUX_S)
#define TSENS_CFG_CLK_MUX_LSI32K    (5 << TSENS_CFG_CLK_MUX_S)
