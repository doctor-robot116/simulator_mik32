...
#define EEPROM_EECON_WRBEH_ONE_PAGE     0
#define EEPROM_EECON_WRBEH_EVEN_PAGES   1
#define EEPROM_EECON_WRBEH_ODD_PAGES    2
#define EEPROM_EECON_WRBEH_ALL_PAGES    3

#define EEPROM_EECON_OP_READ            0
#define EEPROM_EECON_OP_ERASE           1
#define EEPROM_EECON_OP_PROG            2
