...
public:
	...
	void PCD_WriteRegister(PCD_Register reg, uint32_t count, uint8_t *values);
	uint8_t PCD_ReadRegister(PCD_Register reg);
	void PCD_ReadRegister(PCD_Register reg, uint32_t count, uint8_t *values, int rxAlign = 0);
	void PCD_SetRegisterBitMask(PCD_Register reg, uint8_t mask);
	void PCD_ClearRegisterBitMask(PCD_Register reg, uint8_t mask);
	StatusCode PCD_CalculateCRC(uint8_t *data, uint32_t length, uint8_t *result);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	StatusCode PCD_TransceiveData(uint8_t *sendData, uint32_t sendLen, uint8_t *backData, uint8_t *backLen, uint8_t *validBits = nullptr, uint8_t rxAlign = 0, bool checkCRC = false);
	StatusCode PCD_CommunicateWithPICC(uint8_t command, uint8_t waitIRq, uint8_t *sendData, uint32_t sendLen, uint8_t *backData = nullptr, uint8_t *backLen = nullptr, uint8_t *validBits = nullptr, uint8_t rxAlign = 0, bool checkCRC = false);
