# MIK32 АМУР
SDK - Симулятор - Техническая документация

![Демонстрация работы](https://github.com/doctor-robot116/simulator_mik32/blob/main/readme_files/mik32_led_button.gif)

## 1. Описание проекта

**MIK32 SDK** — браузерное учебное приложение для изучения программирования микроконтроллера MIK32 Амур (RISC-V, МИКРОН, Зеленоград).
...
## 12. Каталог инструментов конфигурирования (`/config-tools`)
...
## 13. Встроенный Web-конфигуратор MIK32V2 (`/mik32-configurator`)
...
## 15. Универсальный движок Pin-Configurator (`public/tools/pin-configurator.html`)
...
## 16. Атрибуция и лицензии встроенных материалов
...
### 17. Рекомендуемый учебный workflow
...
---
## 18. Раздел `/baremetal` — SDK без HAL (rabidrabbit/mik32-amur-simple)
...
## 22. Раздел `/compare` — HAL vs Baremetal бок о бок
...
### 22.2 Список пар (`PAIRS` в `compare.tsx`)
